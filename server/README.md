...
## Деплој на оддалечен сервер (опционо)
PHP-от може да се качи на бесплатен PHP/MySQL хост (пр. InfinityFree, 000webhost).
Потоа смени ја `BASE_URL` во `app/.../data/api/ApiClient.java` на адресата на хостот.
